...
public class ReportingUtilities {
    ...
    public static void softAssertTrueWithMessage(SoftAssert sAssert, TestCasePriority priority, boolean passOrFail, String messageIfPassed, String messageIfFailed, String tcId) {
        ...
        calculatePassRates(priority, passOrFail);
        if (passOrFail)
            Reporter.log("<tr><td>" + priority + "<td><b><font color=\"green\">PASSED</font></b></td><td>" + tcId + ":" + messageIfPassed + "</td></tr>");
        else
            Reporter.log("<tr><td>" + priority + "<td><b><font color=\"red\">FAILED</font></b></td><td>" + tcId + ":" + messageIfFailed + "</td></tr>");
    ...
    public static void softAssertFalseWithMessage(SoftAssert sAssert, TestCasePriority priority,  boolean passOrFail, String messageIfPassed, String messageIfFailed, String tcId) {
        ...
        sAssert.assertFalse(passOrFail);
    }
    ...
    public static void geenerateResultsTable () {
        Reporter.log(
                "<hr><table border=1>"
                        ...
                        + "</tr>"
                        + "<tr>"
                            + "<td>P0</td><td>" + passRateMap.get(TestCasePriority.P0).getOverall() + "</td><td>" + passRateMap.get(TestCasePriority.P0).getPassed() + "</td><td>" + (passRateMap.get(TestCasePriority.P0).getOverall()>0?Double.valueOf(passRateMap.get(TestCasePriority.P0).getPassed())/ Double.valueOf(passRateMap.get(TestCasePriority.P0).getOverall())*100:"0") + " %</td>"
                        + "</tr>"
                        + "<tr>"
                        + "<td>P1</td><td>" + passRateMap.get(TestCasePriority.P1).getOverall() + "</td><td>" + passRateMap.get(TestCasePriority.P1).getPassed() + "</td><td>" +  (passRateMap.get(TestCasePriority.P1).getOverall()>0?Double.valueOf(passRateMap.get(TestCasePriority.P1).getPassed())/ Double.valueOf(passRateMap.get(TestCasePriority.P1).getOverall())*100:"0") + " %</td>"
                        + "</tr>"
                        + "<tr>"
                        + "<td>P2</td><td>" + passRateMap.get(TestCasePriority.P2).getOverall() + "</td><td>" + passRateMap.get(TestCasePriority.P2).getPassed() + "</td><td>" +  (passRateMap.get(TestCasePriority.P2).getOverall()>0?Double.valueOf(passRateMap.get(TestCasePriority.P2).getPassed())/ Double.valueOf(passRateMap.get(TestCasePriority.P2).getOverall())*100:"0") + " %</td>"
                        + "</tr>"
                        + "<tr>"
                        + "<td>P3</td><td>" + passRateMap.get(TestCasePriority.P3).getOverall() + "</td><td>" + passRateMap.get(TestCasePriority.P3).getPassed() + "</td><td>" +  (passRateMap.get(TestCasePriority.P3).getOverall()>0?Double.valueOf(passRateMap.get(TestCasePriority.P3).getPassed())/ Double.valueOf(passRateMap.get(TestCasePriority.P3).getOverall())*100:"0") + " %</td>"
                        + "</tr>"
                        + "<tr>"
                        + "<td>P4</td><td>" + passRateMap.get(TestCasePriority.P4).getOverall() + "</td><td>" + passRateMap.get(TestCasePriority.P4).getPassed() + "</td><td>" +  (passRateMap.get(TestCasePriority.P4).getOverall()>0?Double.valueOf(passRateMap.get(TestCasePriority.P4).getPassed())/ Double.valueOf(passRateMap.get(TestCasePriority.P4).getOverall())*100:"0") + " %</td>"
                        + "</tr>"
                + "</table>"
        );
    }
