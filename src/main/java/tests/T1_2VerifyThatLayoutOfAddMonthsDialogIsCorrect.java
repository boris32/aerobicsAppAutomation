...
public class T1_2VerifyThatLayoutOfAddMonthsDialogIsCorrect extends BaseTest {
    ...
    public void verifyAddMonthDialogLayout() {
        Reporter.log("<b>Now testing: Add Month dialog layout<b>");
        ...
        if (amd.isAddMonthDialogInitialLayoutCorrect())
            ...
            Reporter.log("<b><font color=\"ref\">FAILED: </font></b>The layout of 'Add Month Dialog' is IN-correct. Certain controls are missing!");
